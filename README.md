...
gst-qti-oss-patches
Contains patch files for GStreamer opensource plugins, introducing enhancements, fixes and support for Qualcomm specific pixel formats.
...
gst-qti-oss-patches is licensed under the [BSD-3-Clause-Clear License](https://spdx.org/licenses/BSD-3-Clause-Clear.html). See [LICENSE.txt](LICENSE.txt) for the full license text.
